...
**** TODO Controller Node: Prerequisites (doc 3.2.1.3) [8/8]
...
**** TODO Controller Node: Install & Configure Components (doc 3.2.1.3 cont) [8/8]
    ...
    # service nova-novncproxy restart
       #+end_src
**** TODO Install and Configure Compute Node (doc 3.2.1.4) [3/3]
...
------ 
*** DONE Neutron: Install [0/3]
**** TODO Verifiy connectivity [4/4]
...
sgc@compute1:~$
#+end_example
**** TODO Install and configure controller node [5/5]
...
- [X] Finalize (6.2.5)
**** TODO Install and configure compute node [5/5]
