...
- [-] 5.1 _Security_ (Preconfigure VM's) [4/5]
...
- [ ] 5.4 _Package Archives_ (repeat on all nodes) [0/1]
...
- [ ] _Message Queue_ [0/3]
  - [ ] Install Package
  - [ ] Add openstack user
  - [ ] Permit config, write, & read access for user
- [ ] _Memcached_ [0/3]
  - [ ] Install package [0/0]
  - [ ] edit config file
