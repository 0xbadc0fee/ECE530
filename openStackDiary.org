...
+ template build.... 2 core, 6gb ram, 40 gb hdd, 2 NIC
  [[./img/environment000setup(12)-small.png]]
------
...
+ Virtual Network
  ...
  + vSwitch2 = provider network <-> HVS igb3
    [[./img/environment000setup(13)-small.png]]
-----
...
- [X] 5.2 _Host Networking_ [6/6]
  ...
  - [X] Confirm Connectivity: [7/7]
    ...
    - [X] repeat ping from @object2
      [[./img/environment000setup(9)-small.png]]
  - [X] 'object1'
  - [X] 'object2'
- [X] 5.3 _NTP_ [3/3]
  - [X] Controller Node
...
- [X] _Etcd_ (on controller) [2/2]
  - [X] Install Package
  - [X] edit config files
    [[./img/environment000setup(11)-small.png]]
------
...
#+end_src
[[./img/service010keystone(0)-small.png]]
...
#+end_src
[[./img/service010keystone(2)-small.png]]
...
+------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
#+end_example
[[./img/service010keystone(7)-small.png]]
...
- [X] Create the Image Service API
  ...
  #+end_src
[[./img/service020glance(0)-small.png]]
...
sgc@controller:~$
#+end_example
[[./img/service020glance(3)-small.png]]
...
+--------------------------------------+--------+
#+end_example
[[./img/service020glance(2)-small.png]]
------
...
- [X] Finalize Installation
  [[./img/service030placement(0)-small.png]]
...
------
*** TODO Cinder: Install [2/2]
- [X] Configure 'controller' node [4/4]
  - [X] Prerequisites [4/4]
    - [X] Create database & grand access
    - [X] refresh admin credentials
    - [X] create service credentials
    - [X] create service api endpoints
      [[./img/service070cinder(0)-small.png]]
  - [X] Install & Configure Components [0/0]
    1. Install Package(s)
...
- [X] Configure 'block1' node [0/0]
  [[./img/service070cinder(1)-small.png]]
...
- [X] Installation Screenshots
  [[./img/service080swift(1)-small.png]]
  [[./img/service080swift(4)-small.png]]
  [[./img/service080swift(6)-small.png]]
  [[./img/service080swift(15)-small.png]]
  [[./img/service080swift(19)-small.png]]
  [[./img/service080swift(24)-small.png]]
  [[./img/service080swift(26)-small.png]]
  [[./img/service080swift(30)-small.png]]
  [[./img/service080swift(32)-small.png]]
*** TODO Swift: HW RESULTS [1/2]
