...
1.  [HW 1](#orgdd4b3f9)
2.  [Roadmap](#org75e1f85)
3.  [Envrionment Installation Journal](#org1ae430c)
    1.  [Pre-install Tests / Notes](#org23552b5)
        1.  [Trial / Test VM's <code>[6/6]</code>](#orgcec6661)
        2.  [General Notes:](#org13634a4)
        3.  [Hypervisor Install Notes](#org5114dd0)
        4.  [Home Lab Config Notes:](#org2024037)
        5.  [Environment Install Task List / YOGA / UBUNTU (1 VM per host method)](#orgbb547c7)
    2.  [Environment Install Footnotes](#orgc6ebf06)
4.  [Project(s) Installation Journal](#orgac1860b)
        1.  [Projects(s) Install Task List / YOGA / UBUNTU](#orgf50c86e)
...
1.  TODO Keystone: Install <code>[6/6]</code>
...
2.  TODO Keystone: HW RESULTS <code>[4/4]</code>
...
3.  TODO Glance: Install (on controller) <code>[10/10]</code>
...
4.  TODO Glance: HW RESULTS <code>[2/2]</code>
...
5.  TODO Placement: Install

6.  TODO Placement: HW RESULTS

    ---

7.  TODO Neutron: Install

8.  TODO Neutron: HW RESULTS

    ---

9.  TODO Horizon: Install

10. TODO Horizon: HW RESULTS

    ---

11. TODO Cinder: Install

12. TODO Cinder: HW RESUlts
